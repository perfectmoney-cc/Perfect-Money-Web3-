...
export const PaymentComparisonTable = () => {
  const comparisons: ComparisonItem[] = [
    ...
    },
    {
      ...
      perfectMoney: <CheckCircle className="h-5 w-5 text-green-500" />,
      traditional: <XCircle className="h-5 w-5 text-red-500" />,
      crypto: <CheckCircle className="h-5 w-5 text-green-500" />,
    },
    {
