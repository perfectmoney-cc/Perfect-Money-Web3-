...
import { ArrowLeft, Gift, Clock, CheckCircle, ExternalLink, Trophy, Loader2, BarChart3, AlertTriangle, Wallet, Coins } from "lucide-react";
...
const TASK_DEFINITIONS = [
  { id: 0, title: "Like us on Facebook", icon: FaFacebook, link: "https://facebook.com/perfectmoney", color: "text-blue-600" },
  { id: 1, title: "Leave Review on Facebook", icon: FaFacebook, link: "https://facebook.com/perfectmoney/reviews", color: "text-blue-600" },
  { id: 2, title: "Subscribe to Youtube Channel", icon: FaYoutube, link: "https://youtube.com/@perfectmoney", color: "text-red-600" },
  { id: 3, title: "React to any Youtube Videos", icon: FaYoutube, link: "https://youtube.com/@perfectmoney/videos", color: "text-red-600" },
  { id: 4, title: "Follow us on Twitter", icon: FaTwitter, link: "https://twitter.com/perfectmoney", color: "text-sky-500" },
  { id: 5, title: "React or Tweet Post", icon: FaTwitter, link: "https://twitter.com/perfectmoney", color: "text-sky-500" },
  { id: 6, title: "Join Telegram Group", icon: FaTelegram, link: "https://t.me/perfectmoney", color: "text-cyan-500" },
  { id: 7, title: "Review on TrustPilot", icon: SiTrustpilot, link: "https://trustpilot.com/review/perfectmoney.com", color: "text-green-600" },
  { id: 8, title: "Review on Google", icon: SiGoogle, link: "https://g.page/r/perfectmoney/review", color: "text-blue-500" }
];
...
const AirdropPage = () => {
  ...
  const { isLoading: isVisitConfirming, isSuccess: isVisitConfirmed } = useWaitForTransactionReceipt({ hash: visitTxHash });
        ...
        <Card className="p-4 mb-4 bg-gradient-to-br from-primary/10 to-secondary/10 backdrop-blur-sm border-primary/30">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            ...
            <div className="p-2 bg-background/50 rounded-lg text-center">
              ...
              <p className="font-bold">{(Number(maxClaimableFormatted) - Number(totalClaimedFormatted)).toLocaleString()} PM</p>
            </div>
            <div className="p-2 bg-background/50 rounded-lg text-center">
            ...
            <Card className="p-4 md:p-6 bg-card/50 backdrop-blur-sm h-fit">
              ...
              <div className="mb-4 p-3 bg-primary/10 border border-primary/30 rounded-lg">
                <p className="text-xs text-primary flex items-center gap-2">
                  ...
                  <span>Complete all tasks first (free), then claim <strong>{Number(totalRewardFormatted).toLocaleString()} PM</strong> tokens with a one-time fee of <strong>{totalFeeBnb.toFixed(6)} BNB</strong></span>
                </p>
              </div>
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-2 md:gap-3 flex-1 min-w-0">
                        ...
                        <span className={`font-medium text-xs md:text-sm truncate ${isVisited ? 'text-green-500' : ''}`}>{task.title}</span>
                      </div>
                      <Button 
